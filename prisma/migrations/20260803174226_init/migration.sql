...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('ORDERED', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('RAZORPAY', 'COD', 'WHATSAPP');
...
-- CreateTable
CREATE TABLE "filter_attribute_values" (
    "id" TEXT NOT NULL,
    "attributeId" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "colorHex" TEXT,

    CONSTRAINT "filter_attribute_values_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "filter_attributes" (
    ...
    CONSTRAINT "filter_attributes_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "filter_attribute_values_attributeId_value_key" ON "filter_attribute_values"("attributeId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "filter_attributes_name_key" ON "filter_attributes"("name");

-- CreateIndex
CREATE UNIQUE INDEX "filter_attributes_slug_key" ON "filter_attributes"("slug");

-- CreateIndex
CREATE INDEX "product_attribute_values_productId_idx" ON "product_attribute_values"("productId");

-- CreateIndex
CREATE INDEX "product_attribute_values_valueId_idx" ON "product_attribute_values"("valueId");

-- CreateIndex
CREATE UNIQUE INDEX "product_attribute_values_productId_valueId_key" ON "product_attribute_values"("productId", "valueId");
...
-- AddForeignKey
ALTER TABLE "filter_attribute_values" ADD CONSTRAINT "filter_attribute_values_attributeId_fkey" FOREIGN KEY ("attributeId") REFERENCES "filter_attributes"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "product_attribute_values" ADD CONSTRAINT "product_attribute_values_valueId_fkey" FOREIGN KEY ("valueId") REFERENCES "filter_attribute_values"("id") ON DELETE CASCADE ON UPDATE CASCADE;
